    ...
    c.on('data', d => {
      ...
      if (d.t === TOPICS.RPC_EXECUTOR) {
        ...
        if (d.m.result !== undefined || d.m.error !== undefined || d.m.progress !== undefined) {
          ...
          rpcRequests.add(d.m.id, c.id, d.m.procedure, d.m.args, d.m.affinity, d.m.withStatus)
          if (d.m.withStatus) c.write({ t: TOPICS.RPC_EXECUTE, m: { id: d.m.id, progress: 'scheduled' } })
          executeProcedures()
        }
